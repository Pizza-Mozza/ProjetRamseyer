...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $requete = $pdo->prepare("SELECT * FROM utilisateur WHERE email_utilisateur = :email");
    ...
    if ($Res != false) {
        $erreurs['email_utilisateur'] = "L'adresse email est déjà prise";
    }
...
<body class="bg-dark-subtle">
    ...
    <div class="w-50 mx-auto shadow p-4 bg-light-subtle mt-3 mb-5">
        <form action="" method="post" novalidate>
            ...
            id=" exampleInputEmail1" name="email_confirmation" value="<?= $email_confirmation ?>"
                    placeholder="Confirmez votre mail" aria-describedby="emailHelp">
                <div id="emailHelp" class="form-text"></div>
            ...
            id=" mdp" name="mdp" value="<?= $mdp_utilisateur ?>" placeholder="Saisir votre mot de passe"
                ...
                <div id="emailHelp" class="form-text">Votre mot de passe doit contenir une majuscule, une minuscule et
                    un chiffre</div>
                <?php if (isset($erreurs['email'])): ?>
